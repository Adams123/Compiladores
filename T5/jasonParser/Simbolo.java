...
public class Simbolo
{
    ...
    public void setValue(int valor){this.valorInt=valor;this.tipo=tipos.INTEGER;}
    public void setValue(float valor){this.valorReal=valor;this.tipo = tipos.REAL;}
    public void setValue(String valor){this.valorString=valor;this.tipo = tipos.STRING;}
    
    public int getNivel(){return this.nivel;}
    public classes getClasse(){return this.classe;}
    public tipos getTipo(){return this.tipo;}
    ...
    public static Simbolo searchByID(String s, Stack<Simbolo> stack)
    {
        Simbolo t = new Simbolo();
        t.setId(s);
        return stack.get(stack.search(t));
    }
}
